...
import { MapPin, Mail, Globe, GraduationCap, Mars, Code, BadgeCheckIcon } from "lucide-react";
    ...
    <section  className="space-y-0">
      ...
      <div className="flex items-start border-y">
        ...
        <div className="flex-1 mt-auto mb-2 space-y-2">
          <div className="flex items-center border-y">
            <h1 className="text-xl sm:text-2xl md:text-3xl ml-3 sm:ml-5 md:ml-6 font-semibold">Mujtaba Mohamed</h1>
      ...
      <ul className="grid gap-2 text-sm md:text-md px-4 sm:px-6 mt-6 sm:mt-8 py-4 sm:py-6 text-foreground border-y">
        ...
        <li className="flex items-center gap-4 ">
          ...
          B.Tech in Information Technology (CGPA: 8.94)
        </li>
        ...
        <li className="flex items-center gap-4">
          ...
          <Link 
            target="_blank" 
            href="mailto:mujtabamohamed@gmail.com">
        ...
        <li className="flex items-center gap-4">
          <div className="bg-card rounded-md border p-1 custom-shadow">
            ...
            <Link 
              target="_blank" 
              href="https://mujtabamohamed.vercel.app">
