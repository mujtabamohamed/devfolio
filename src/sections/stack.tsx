...
export function Stack() {
  ...
  const items = [
    ...
    { 
      name: "Next.js", 
      icon: currentTheme === "dark" ? "/tech-icons/Nextjs-White.svg" : "/tech-icons/Nextjs-Black.svg", 
      shortName: "Next.js" 
    },
    ...
    { name: "PostgreSQL", icon: "/tech-icons/PostgresSQL.svg", shortName: "PostgreSQL" },
    { name: "MySQL", icon: "/tech-icons/MySQL.svg", shortName: "MySQL" },
    { name: "Firebase", icon: "/tech-icons/Firebase.svg", shortName: "Firebase" },
    { name: "Supabase", icon: "/tech-icons/Supabase.svg", shortName: "Supabase" },
    { name: "HTML", icon: "/tech-icons/HTML.svg", shortName: "HTML" },
    { name: "CSS", icon: "/tech-icons/CSS.svg", shortName: "CSS" },
    { name: "Tailwind", icon: "/tech-icons/Tailwind.svg", shortName: "Tailwind" },
    ...
    { 
      name: "AWS", 
      icon: currentTheme === "dark" ? "/tech-icons/AWS-White.svg" : "/tech-icons/AWS-Black.svg", 
      shortName: "AWS" 
    },
  ...
  return (
    <section className="space-y-0" id="stack">
      <h2 className="text-2xl md:text-3xl font-semibold border-y px-4 md:px-6">Stack</h2>
                ...
                <div className="flex items-center cursor-pointer">
                  {typeof tech.icon === 'function' ? (
                    ...
                    <Image 
                      ...
                      onError={(e) => {
                        console.error(`Failed to load icon for ${tech.name}: ${tech.icon}`);
                      }}
                    />
                  )}
                </div>
